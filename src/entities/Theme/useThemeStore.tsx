...
export const createThemeStore = (initialTheme: Theme = "light") => {
...
if (typeof document !== "undefined") {
  const cookie = document.cookie
    .split("; ")
    .find((str) => str.startsWith("theme-storage"));
...
const themeStoreContext = React.createContext<ThemeStore | undefined>(
  undefined,
);
