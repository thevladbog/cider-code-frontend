...
import { SHIFTS_MOCK } from '@/app/lib/mocks';
...
export const ShiftTable = () => {
  ...
  const ShiftTableWrapper = withTableSorting(withTableActions<IShiftData>(Table));
  ...
  return (
    <div className={s.root}>
      <Text variant="display-1" qa="shift.table.header" color="info">
        Смены
      </Text>
