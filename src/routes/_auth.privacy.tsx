        ...
        <div className={s.content}>
          ...
          <div className={s.section}>
            ...
            <div>
              <TextWrapper variant="body-1" className={s.paragraph}>
                ...
                обработки и защиты персональных данных пользователей системы
                управления производством Bottle Code (далее — «Система»). Мы
                серьезно относимся к защите ваших персональных данных и
                обязуемся соблюдать принципы их безопасной обработки.
              </TextWrapper>
            </div>
          </div>
          ...
          <div className={s.section}>
            ...
            <ul className={s.list}>
              ...
              <li>
                <TextWrapper variant="body-1">
                  Рабочие данные и записи операций — в соответствии с
                  требованиями к производственной отчетности (не менее 5 лет)
                </TextWrapper>
              </li>
              <li>
                <TextWrapper variant="body-1">
          ...
          <div className={s.section}>
            ...
            <div>
              <TextWrapper variant="body-1" className={s.paragraph}>
                Система использует файлы cookie для обеспечения функциональности
                и улучшения пользовательского опыта. Cookie используются для:
              </TextWrapper>
            </div>
            <ul className={s.list}>
              <li>
          ...
          <div className={s.section}>
            ...
            <div>
              <TextWrapper variant="body-1" className={s.paragraph}>
                ...
                пользователей через систему уведомлений не менее чем за 30 дней
          ...
          <div className={s.disclaimer}>
            <TextWrapper variant="body-2" color="secondary">
              Данная политика конфиденциальности вступает в силу с момента
              начала использования системы управления производством Bottle Code
              и действует до её отзыва или замены новой версией.
            </TextWrapper>
          </div>
        </div>
      </Container>
